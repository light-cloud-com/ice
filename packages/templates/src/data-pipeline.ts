...
export const eventStreamingTemplate: ComposedTemplate = {
  ...
  blocks: [
    ...
    // 0: Internet
    { iceType: 'Network.PublicEndpoint', label: 'Public Traffic', position: { x: 50, y: 86 }, data: { domain: 'events.myapp.com', enableHttps: true, autoProvisionCert: true, redirectHttpToHttps: true } },
    // 1: WAF
