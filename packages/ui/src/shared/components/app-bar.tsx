...
export const AppBar: React.FC = memo(() => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0" style={isElectron ? { WebkitAppRegion: 'no-drag' } as any : undefined}>
        ...
        <div className="flex items-center gap-0.5" style={isElectron ? { WebkitAppRegion: 'no-drag' } as any : undefined}>
          ...
          <button onClick={decreaseFontSize} disabled={fontSize === 'small'} title="Decrease font size"
          ...
          <button onClick={increaseFontSize} disabled={fontSize === 'large'} title="Increase font size"
