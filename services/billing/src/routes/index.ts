...
router.post('/usage-history', requireAuth, requireOrgRole('owner', 'admin'), (req, res) =>
  getUsageHistory(req as any, res),
);

router.post('/invoices', requireAuth, requireOrgRole('owner', 'admin'), (req, res) => listInvoices(req as any, res));

router.post('/invoice/:invoiceId', requireAuth, requireOrgRole('owner', 'admin'), (req, res) =>
  getInvoice(req as any, res),
);
...
router.post('/payment-method/setup', requireAuth, requireOrgRole('owner'), (req, res) =>
  createSetupIntent(req as any, res),
);

router.post('/payment-method', requireAuth, requireOrgRole('owner'), (req, res) =>
  updatePaymentMethod(req as any, res),
);

router.post('/payment-method/remove', requireAuth, requireOrgRole('owner'), (req, res) =>
  removePaymentMethod(req as any, res),
);
...
router.post('/details', requireAuth, requireOrgRole('owner', 'admin'), (req, res) =>
  updateBillingDetailsRoute(req as any, res),
);

router.post('/details/get', requireAuth, requireOrgRole('owner', 'admin'), (req, res) =>
  getBillingDetailsRoute(req as any, res),
);
