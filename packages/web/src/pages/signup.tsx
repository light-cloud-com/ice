...
export const SignupPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ice-base relative overflow-hidden">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-ice-accent/[0.03] blur-[120px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-[380px] space-y-8 px-4">
        ...
        <form onSubmit={handleSubmit} className="ice-card" id="ice-signup-auth-form">
          <div className="ice-card-header">
            <h2 className="text-base font-semibold text-ice-text-1">Create your account</h2>
          </div>
