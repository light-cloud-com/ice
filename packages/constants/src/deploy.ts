 ...
 */
export const DEFAULT_DISPLAY_PROVIDER: Provider = 'aws';
...
export const TERMINAL_DEPLOY_ACTIONS: DeployActionType[] = ['apply', 'rollback', 'destroy'];

/** Statuses that mean a deploy/destroy is finished (no more events expected). */
export const TERMINAL_DEPLOY_STATUSES: DeployRowStatus[] = ['success', 'partial', 'failed', 'cancelled'];
 ...
 */
export const DEPLOY_ACTION_LABELS: Record<string, string> = {
  plan: 'Plan',
  apply: 'Deploy',
  destroy: 'Destroy',
  rollback: 'Rollback',
 ...
 */
export const DEPLOY_ACTION_COLOR_CLASSES: Record<string, string> = {
