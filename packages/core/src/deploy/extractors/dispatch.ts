...
import {
  extract_oci_analytics_instance_properties,
  extract_oci_apigateway_gateway_properties,
  extract_oci_artifacts_repository_properties,
  extract_oci_certificates_certificate_properties,
  extract_oci_containerengine_cluster_properties,
  extract_oci_containerinstance_properties,
  extract_oci_database_autonomous_properties,
  extract_oci_datascience_modeldeployment_properties,
  extract_oci_dns_zone_properties,
  extract_oci_functions_function_properties,
  extract_oci_generativeai_endpoint_properties,
  extract_oci_identitydomains_user_properties,
  extract_oci_instance_properties,
  extract_oci_loadbalancer_properties,
  extract_oci_logging_loggroup_properties,
  extract_oci_monitoring_alarm_properties,
  extract_oci_mysql_dbsystem_properties,
  extract_oci_nosql_table_properties,
  extract_oci_nsg_properties,
  extract_oci_objectstorage_bucket_properties,
  extract_oci_ons_topic_properties,
  extract_oci_privateaccessgateway_properties,
  extract_oci_psql_dbsystem_properties,
  extract_oci_queue_properties,
  extract_oci_redis_cluster_properties,
  extract_oci_resourcescheduler_properties,
  extract_oci_streaming_stream_properties,
  extract_oci_subnet_properties,
  extract_oci_vault_secret_properties,
  extract_oci_vcn_properties,
  extract_oci_waf_policy_properties,
} from './oci';
...
> = {
  ...
  // ─── OCI — P0 handlers ──────────────────────────────────────────────
  'oci.core.instance': extract_oci_instance_properties,
  'oci.core.vcn': extract_oci_vcn_properties,
  'oci.core.subnet': extract_oci_subnet_properties,
  'oci.core.networksecuritygroup': extract_oci_nsg_properties,
  'oci.containerinstance.instance': extract_oci_containerinstance_properties,
  'oci.functions.function': extract_oci_functions_function_properties,
  'oci.resourcescheduler.schedule': extract_oci_resourcescheduler_properties,
  'oci.psql.dbsystem': extract_oci_psql_dbsystem_properties,
  'oci.mysql.dbsystem': extract_oci_mysql_dbsystem_properties,
  'oci.database.autonomousdatabase': extract_oci_database_autonomous_properties,
  'oci.nosql.table': extract_oci_nosql_table_properties,
  'oci.redis.cluster': extract_oci_redis_cluster_properties,
  'oci.objectstorage.bucket': extract_oci_objectstorage_bucket_properties,
  'oci.vault.secret': extract_oci_vault_secret_properties,

  // ─── OCI — P1 handlers ──────────────────────────────────────────────
  'oci.loadbalancer.loadbalancer': extract_oci_loadbalancer_properties,
  'oci.dns.zone': extract_oci_dns_zone_properties,
  'oci.apigateway.gateway': extract_oci_apigateway_gateway_properties,
  'oci.core.privateaccessgateway': extract_oci_privateaccessgateway_properties,
  'oci.containerengine.cluster': extract_oci_containerengine_cluster_properties,
  'oci.artifacts.repository': extract_oci_artifacts_repository_properties,
  'oci.identitydomains.user': extract_oci_identitydomains_user_properties,
  'oci.certificates.certificate': extract_oci_certificates_certificate_properties,
  'oci.waf.policy': extract_oci_waf_policy_properties,
  'oci.logging.loggroup': extract_oci_logging_loggroup_properties,

  // ─── OCI — P2 handlers ──────────────────────────────────────────────
  'oci.queue.queue': extract_oci_queue_properties,
  'oci.streaming.stream': extract_oci_streaming_stream_properties,
  'oci.ons.topic': extract_oci_ons_topic_properties,
  'oci.analytics.instance': extract_oci_analytics_instance_properties,
