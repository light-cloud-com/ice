 ...
 */
export const GCP_BASE_APIS: readonly string[] = [
 ...
 */
export const GCP_ICE_TYPE_API_MAP: Record<string, readonly string[]> = {
  // Compute
 ...
 */
export const GCP_API_NOT_ENABLED_PATTERNS: readonly string[] = [
