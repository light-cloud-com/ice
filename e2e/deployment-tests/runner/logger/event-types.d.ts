...
export type EventBody = PhaseStartEvent | PhaseEndEvent | UiActionEvent | ScreenshotEvent | ApiCallEvent | ApiResponseEvent | ApiErrorEvent | ErrorClassifiedEvent | RecipeAttemptEvent | RecipeResultEvent | GcloudCheckEvent | GcloudResultEvent | NoteEvent | WaitForHumanEvent | DeployLogTailEvent;
