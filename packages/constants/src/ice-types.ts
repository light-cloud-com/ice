...
export const TREE = {
  Compute: {
    ...
    resources: {
      ...
      ServerlessFunction: { id: 'serverless-function', aliases: ['Function'], required: ['memory', 'timeout', 'runtime'] },
    },
  },
  Database: {
    category: Cat.Data,
  ...
  Storage: {
    category: Cat.Data,
    resources: {
      Bucket: { id: 'object-storage', aliases: ['ObjectStorage', 'S3', 'GCS', 'Blob'], envVar: 'STORAGE_BUCKET', required: ['storage_class'] },
  ...
  Messaging: {
    ...
    resources: {
      ...
      CloudPubSub: { id: 'cloud-pubsub',  aliases: ['Kafka', 'EventStream'], envVar: 'PUBSUB_TOPIC',        required: ['keep_messages'] },
