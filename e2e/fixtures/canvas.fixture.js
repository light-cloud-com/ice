...
export const test = base.extend({
    authenticatedPage: async ({ authenticatedPage }, use) => {
        ...
        if (!onCanvas) {
            ...
            const newProjectBtn = authenticatedPage.locator('button:has-text("New Project"), button:has-text("Create"), [data-testid="new-project"]');
            if (await newProjectBtn
                .first()
...
export class CanvasHelper {
    ...
    async dragFromPalette(blockType, targetX, targetY) {
