...
export const STORAGE_GB_BY_TIER: Record<string, number> = {
  dev: 1,
  low: 10,
  moderate: 50,
  medium: 200,
...
export const REQUESTS_M_BY_TIER: Record<string, number> = {
  dev: 0.01,
  low: 0.1,
  moderate: 1,
  medium: 10,
 ...
 */
export const TIER_SCALE_FACTOR: Record<string, number> = {
  dev: 0,
  low: 0.1,
  moderate: 0.25,
  medium: 0.5,
...
export const ICE_PREFIX_TO_COST_CATEGORY: Record<string, string> = {
  Compute: 'Compute',
  Database: 'Data',
  Storage: 'Data',
  Messaging: 'Messaging',
