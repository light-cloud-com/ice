 ...
 * Single source of truth: @ice-saas/types/connection-rules
 *
...
import { isBackend as _isBackend, isDatabase as _isDatabase, isCache as _isCache } from '@ice-saas/types';
