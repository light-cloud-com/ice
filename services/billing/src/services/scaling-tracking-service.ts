...
export async function pollAndRecordScalingEvents() {
  return { polled: 0, scaledUp: 0, scaledDown: 0 };
}

export function calculateBillableHours(_serviceId: string, _from: Date, _to: Date): number {
