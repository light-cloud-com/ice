...
const state = {
  deployResult: 'success' as 'success' | 'failure',
  requests: new Map<string, any[]>(),
};

export function setDeployResult(result: 'success' | 'failure') {
  state.deployResult = result;
}

export function getRequests(path: string): any[] {
...
function recordRequest(path: string, body: any) {
