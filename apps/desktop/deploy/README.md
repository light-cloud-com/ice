...
Build a distributable: `pnpm --filter @ice/desktop dist`. Signed builds are on the v0.2 roadmap — for now the binaries are unsigned and you'll need to click through the OS warnings on first launch. See [docs/architecture/desktop.md](../../docs/architecture/desktop.md).
