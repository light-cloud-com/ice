 ...
 */
import { import_pulumi_state_json, import_result_to_graph, parse_urn, parse_type, get_ice_type, get_ice_provider, get_provider_from_type, is_type_supported, is_provider_resource, is_stack_resource, } from '../importers/pulumi';
// =============================================================================
...
describe('Pulumi State Importer', () => {
    ...
    describe('type filtering', () => {
        it('should filter by included types', () => {
            ...
            expect(result.resources.every((r) => ['aws:ec2/vpc:Vpc', 'aws:ec2/subnet:Subnet'].includes(r.pulumi_type))).toBe(true);
        });
