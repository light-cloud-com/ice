    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          options: ['No login needed', 'API key', 'Username & password tokens', 'Social login (Google, GitHub, etc.)'],
    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          tier: 'essential',
          description:
            'Each task runs on its own schedule. Add separate tasks for different cadences (e.g. nightly backup + hourly sync).',
          addLabel: 'Add a task',
        },
        {
          name: 'timezone',
