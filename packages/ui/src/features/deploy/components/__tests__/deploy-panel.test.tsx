...
const mocks = vi.hoisted(() => ({
  ...
  ApiErrorBanner: vi.fn(() => null),
  DeployControls: vi.fn(() => null),
  DeployDiagnosis: vi.fn(() => null),
  DeployInFlightPanel: vi.fn(() => null),
  DestroyConfirmModal: vi.fn(() => null),
  PlanPreview: vi.fn(() => null),
  PreDeployWarnings: vi.fn(() => null),
  RequirementsSection: vi.fn(() => null),
  ResultsSummary: vi.fn(() => null),
  AuthBanner: vi.fn(() => null),
  ConfigSection: vi.fn(() => null),
  DeployedResourcesList: vi.fn(() => null),
  DnsRecordsSection: vi.fn(() => null),
  LogPanel: vi.fn(() => null),
  StatusBadge: vi.fn(() => null),
  PanelHeader: vi.fn(() => null),
  // Hook returns.
