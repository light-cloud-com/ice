/**
 * High-level resource category: MESSAGING.
 *
 * Queues, pub/sub, and event streaming.
 *
 * SIZE EXCEPTION: this file is intentionally >500 LOC because it is dominated
 * by data — queue/pubsub/stream catalogues with deep optionDetails arrays
 * total ~840 LOC of pure literal. The split-by-category boundary is the
 * stable seam; further fragmentation would not improve readability.
 *
 * The exported `messaging: HighLevelCategory` is consumed by `../high-level-resources.ts`
...
export const messaging: HighLevelCategory = {
  id: 'messaging',
  name: 'Messaging',
        ...
        },
        {
          ...
          optionDetails: [
            ...
            },
            {
              ...
              cost: '~$10/mo',
              provider: 'azure',
              tooltip: 'Shared infrastructure. Adds topics, subscriptions, filters, sessions, and dead-letter queues.',
            },
            {
              value: 'premium',
              label: 'Premium',
